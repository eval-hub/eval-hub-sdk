...
class TestClientInheritance:
    ...
    async def test_async_evalhub_client_has_all_resources(self) -> None:
        ...
        assert hasattr(client.providers, "create")
        assert hasattr(client.providers, "update")
        assert hasattr(client.providers, "patch")
        assert hasattr(client.providers, "delete")
        assert hasattr(client.benchmarks, "list")
        assert hasattr(client.collections, "list")
        assert hasattr(client.collections, "get")
        assert hasattr(client.collections, "create")
        assert hasattr(client.collections, "update")
        assert hasattr(client.collections, "patch")
        assert hasattr(client.collections, "delete")
