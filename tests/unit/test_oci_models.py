...
class TestOCICoordinate:
    ...
    def test_oci_coordinate_required_fields(self):
    ...
    def test_oci_coordinate_with_subject(self):
    ...
    def test_oci_coordinate_deserialization(self):
...
class TestEvaluationJobFilesLocation:
    ...
    def test_evaluation_job_files_location_empty(self):
    ...
    def test_evaluation_job_files_location_with_path(self):
    ...
    def test_evaluation_job_files_location_defaults(self):
    ...
    def test_evaluation_job_files_location_metadata_type(self):
...
class TestPersistResponse:
    ...
    def test_persist_response_required_fields(self):
    ...
    def test_persist_response_with_metadata(self):
    ...
    def test_persist_response_digest_format(self):
    ...
    def test_persist_response_zero_files(self):
