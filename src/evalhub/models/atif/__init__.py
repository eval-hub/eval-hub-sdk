...
This module provides Pydantic models for validating and constructing trajectory
data following the ATIF specification. Ported from Harbor as a self-contained
subpackage — no Harbor dependency required.
"""
